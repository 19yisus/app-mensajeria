...
class ModeloUsuario  implements usuario {
    ...
    async registrar():Promise<QueryResult>{
        let sql:string = "INSERT INTO tusuario(id_persona,correo,telefono,clave,pregunta_1,pregunta_2,respuesta_1,respuesta_2,estado_usuario) VALUES($1,$2,$3,$4,$5,$6,$7,$8);"
        let datos:string[] = [this.id_persona,this.correo,this.telefono,this.clave,this.pregunta_1,this.pregunta_2,this.respuesta_1,this.respuesta_2,this.estado_usuario,'1']
